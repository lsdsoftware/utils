...
import { CLIRequest, makeCLIWorkerRotator } from "./cli-worker-rotator.js"
...
function makeEchoChild(): ChildProcessByStdio<Writable, Readable, null> {
  const child = new EventEmitter() as ChildProcessByStdio<Writable, Readable, null>
